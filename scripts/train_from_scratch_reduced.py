"""
Train from scratch with reduced dataset and new categories.
Uses pretrained weights as starting point for faster convergence.
"""

import os
from train_df2_maskcrnn import train

def train_from_scratch_reduced():
    """Train from scratch with reduced dataset."""
    print("🚀 Fashion AI Pipeline - Train from Scratch (Reduced Dataset)")
    print("=" * 60)
    
    print("📊 Training Configuration:")
    print("   • Starting: From scratch with pretrained weights")
    print("   • Epochs: 12")
    print("   • Batch size: 4")
    ...
    try:
        train(
            ...
            max_train_images=20000,  # Reduced dataset for faster training
            max_val_images=4000,
        )
